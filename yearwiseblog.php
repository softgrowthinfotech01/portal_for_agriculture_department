...
$year=$_GET['y'];
$stmt_question_list = $conn->prepare("SELECT * FROM blog WHERE added_on LIKE '%$year%' AND blog_status=1 ORDER BY added_on DESC");
$stmt_question_list->execute();
$row_question_list = $stmt_question_list->fetchAll(PDO::FETCH_ASSOC);
//print_r($row_question_list);exit;
?>
    ...
    <!-- /.stricky-header -->
        ...
        <section class="blog-page">
            <div class="container">
                ...
                {
                    echo "<h1>No blogs found for this year.</h1>";
                }
                    ?>
          ...
          <!--  <div class="socializer a sr-32px sr-opacity sr-icon-white sr-pad"><span class="sr-facebook"><a href="https://www.facebook.com/share.php?u=https://atmachandrapur.in/atma/blog" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></span>
