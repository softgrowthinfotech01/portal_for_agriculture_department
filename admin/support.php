...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          <ul>
              <li>
                  Click On <b>Add Category</b>  from menu > Add Category name like e.g SMART , ATMA. >Select Image fot that category >click Submit
              </li>
   ...
   <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingOne">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseadd" aria-expanded="false" aria-controls="flush-collapseOne">
     <b> How to Add District?</b>
      </button>
    </h2>
    <div id="flush-collapseadd" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          <ul>
              <li>
                  Click On <b>District</b>  from menu > Add District name like e.g Chandrapur , Nagpur >click Submit
              </li>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingOne">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseBlog" aria-expanded="false" aria-controls="flush-collapseOne">
     <b> How to Add Blog?</b>
      </button>
    </h2>
    <div id="flush-collapseBlog" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          <ul>
              <li>
...
<b>How to Update/Edit Blog?</b>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingOne">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
     <b> How to Add User/New Organization?</b>
      </button>
    </h2>
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          <ul>
              <li>
                  Click On <b>User</b>  from menu > Enter the data District, User name , user email , password , phone number , image .>click Submit
              </li>
