...
//get all categories
$stmt_question_list = $conn->prepare("SELECT * FROM blog ORDER BY blog_id DESC");
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    if($row_question_list)
                    {
                      ...
                      <tr class="my_text">
                        ...
                        <td>
                        <?php 
                            $stmt_dist = $conn->prepare("SELECT * FROM district WHERE district_id=".$row_question_list[$c]['district_id']);
                            $stmt_dist->execute();
                            $row_dist = $stmt_dist->fetchAll(PDO::FETCH_ASSOC);
                            echo $row_dist[0]['district_name'];
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" onclick="startsession('sess_blog_id',<?php echo $row_question_list[$c]['blog_id'];?>)">View</button> 
                            <button type="button" class="btn btn-primary" onclick="startsession2('sess_blog_id',<?php echo $row_question_list[$c]['blog_id'];?>)">Update</button>
                        <?php 
                            //echo $row_question_list[$c]['blog_text'];
                        ?>
                        </td>
                      </tr>
                      <?php
                ...
                <script>
                /*function func_edit_question(blog_id)
                {
                    $.ajax({
                ...
                function confirm_delete(blog_id)
                {
                    ...
                    function startsession2(name,value)
                    {
                        $.ajax({
                          url: "createsession.php",
                          method:'POST',
