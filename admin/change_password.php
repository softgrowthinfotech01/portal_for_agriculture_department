...
{
  extract($_POST);
       $stmt = $conn->prepare("UPDATE admin_details SET admin_password=:admin_password WHERE admin_details_id=1");
       $executed=$stmt->execute(array(':admin_password' => $admin_password));
       if($executed){
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="card card-primary">
              ...
              <script>
                  ...
                  {
                    if(frm.admin_password.value!=frm.repeat_password.value)
                    {
