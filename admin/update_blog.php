...
if(isset($_POST['submit_question']))
{
    ...
    $targetFilePath = $targetDir . $fileName; 
         ...
         if(in_array($fileType, $allowTypes)){ 
             ...
             if(move_uploaded_file($_FILES["blog_title_image"]["tmp_name"], "../uploaded_images/blog_title_images/".$date1)){
                    ...
                    $executed=$stmt->execute(array(':blog_title' => $blog_title,':blog_title_image' => $date1,':blog_text' => $blog_text,':category_id' => $category_id,':blog_status' => $blog_status2,':blog_id' => $blog_id));
                    if($executed){
  ...
  else
  {
                    ...
                    $executed=$stmt->execute(array(':blog_title' => $blog_title,':blog_text' => $blog_text,':category_id' => $category_id,':blog_status' =>$blog_status2,':blog_id' => $blog_id));
                    if($executed){
                       echo '<script>alert("Blog updated.");window.location.href = "all_blogs";</script>';
                    }
  }
                                ...
                                <div class="card-body col-md-12 mx-auto border mb-3">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="blog_status2"  <?php if($row_blog[0]['blog_status']==1)echo "checked";?> value="1" id="add_user_active">
                                      <label for="add_user_active" class="form-check-label">Active</label>
                                    </div>
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="blog_status2" value="2" id="add_user_inactive" <?php if($row_blog[0]['blog_status']==2)echo "checked";?>>
